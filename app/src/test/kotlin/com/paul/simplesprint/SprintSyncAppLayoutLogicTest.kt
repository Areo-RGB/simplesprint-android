...
class SprintSyncAppLayoutLogicTest {
    ...
    @Test
    fun `setup actions show host button only on tablet role choice devices`() {
        assertTrue(shouldShowSetupHostAction(showTabletRoleChoice = true, tabletAlwaysHost = false))
        assertFalse(shouldShowSetupHostAction(showTabletRoleChoice = false, tabletAlwaysHost = false))
        assertTrue(shouldShowSetupHostAction(showTabletRoleChoice = false, tabletAlwaysHost = true))
    }

    @Test
    fun `setup actions hide connect when tablet host flag is enabled`() {
        assertTrue(shouldShowSetupConnectAction(showTabletRoleChoice = true, tabletAlwaysHost = false))
        assertTrue(shouldShowSetupConnectAction(showTabletRoleChoice = false, tabletAlwaysHost = false))
        assertFalse(shouldShowSetupConnectAction(showTabletRoleChoice = true, tabletAlwaysHost = true))
    }

    @Test
    fun `setup connect button label is tablet-host specific`() {
        assertEquals("Connect to Tablet Host", setupConnectButtonLabel())
    }
